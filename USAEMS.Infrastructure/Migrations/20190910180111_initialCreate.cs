            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        ...
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn)
                        .Annotation("Sqlite:Autoincrement", true),
                    IncidentEventId = table.Column<string>(nullable: true),
                    IncidentLocation = table.Column<string>(nullable: true),
                    IncidentTime = table.Column<DateTime>(nullable: false),
                    PatronFirstName = table.Column<string>(nullable: true),
                    PatronLastName = table.Column<string>(nullable: true),
                    PatronAddress = table.Column<string>(nullable: true),
                    PatronCity = table.Column<string>(nullable: true),
                    PatronState = table.Column<string>(nullable: true),
                    PatronZIP = table.Column<int>(nullable: false),
                    PatronPhone = table.Column<string>(nullable: true),
                    PatronDOB = table.Column<DateTime>(nullable: false),
                    PatronEmail = table.Column<string>(nullable: true),
                    IncidentDescription = table.Column<string>(nullable: true),
                    EmployeeId = table.Column<string>(nullable: true),
                    IncidentCaseNumber = table.Column<string>(nullable: true),
                    EventId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
